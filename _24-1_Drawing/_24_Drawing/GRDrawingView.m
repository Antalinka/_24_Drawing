...
-(void)drawRect:(CGRect)rect{
    ...
    [self drawStarWithRect];
}

-(void)drawStarWithRect {
    

    CGRect rect1 = CGRectMake(0, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame));
    ...
    while (a < 5) {
        ...
        CGPoint point = [self randomPointWithRect:rect1];
    ...
    for (NSValue *value in self.centerAllStars) {
        ...
        [self orderCallMethodsWithRect:rect1 andPoint:point2];
